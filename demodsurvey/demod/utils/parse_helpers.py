...
def replace_with_dict(ar, dic):
    """Convert the elements of an array based on a dictionary .
    ...
    """
    # Extract out keys and values from the dictionary
    ...
    # Searchsorted to get the corresponding places for a in keys 
    # (using sorter since a is not necessarily sorted).
    # Then trace it back to original order with indexing into sidx
    # Finally index into values for desired output.
    replaced_ar = vs[np.searchsorted(ks,ar)]
